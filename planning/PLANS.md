...
| FP64 matrix memory placement | `planning/analysis/fp64-matrix-mem-placement.md` | 2026-08-20 | four `matrix-placement-control` attempts; default fill and buffer sweep, register step untested | Analyzed | `fill-device=1` with buffer 3048 reaches 2.1763e+06 GFLOP/s (+18.01% vs matched control); larger buffers decline monotonically; register step is untested | Repeat default fill versus matched control, refine buffer around 3048/8192, then run a controlled register-step sweep |
